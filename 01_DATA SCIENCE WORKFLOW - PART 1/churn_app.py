...
model = load('/Users/cardinality/Documents/BIA/gndy-dsa-july2025/01_DATA SCIENCE WORKFLOW - PART 1/random_forest_model_5features.joblib')
...
#monthly_charges = st.selectbox("Monthly Charge", ('99', '199', '299'))
